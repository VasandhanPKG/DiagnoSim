        ...
        >
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <motion.div 
              ...
              className="relative overflow-hidden bg-white rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-200/50 print:shadow-none print:border-slate-300"
            >
